...
<body>
	<div id="exTab1" class="container">
		<ul class="nav nav-pills">
			<h1>
				<a href="#"><span>MedApp</span></a>
			</h1>
			<li class="home selected"><a class="active"
				href="<c:url value='/home' />"><span>Home</span></a></li>
	...
	<div>
		...
		<form:form method="POST" modelAttribute="chosenPacient"
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:input type="number" step="any" path="pesel" id="pesel"
							required="true" />
					</div>
				</div>
			</div>
